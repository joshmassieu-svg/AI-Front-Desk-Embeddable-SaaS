# Flowdexx AI Assistant Platform (demo.flowdexx.com)

An enterprise-grade, production-ready platform that allows businesses to embed an AI website assistant using a single JavaScript snippet.
...
```html
<script src="https://demo.flowdexx.com/widget.js" data-website-id="site_flowdexx_123" async></script>
```
