...
export default function DemoEmbedPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1d] text-slate-100 flex flex-col justify-between relative overflow-hidden">
      {/* Top Banner Notice */}
      <div className="bg-gradient-to-r from-brand-900 via-brand-900 to-slate-900 border-b border-brand-500/30 px-6 py-2.5 flex items-center justify-between text-xs">
      ...
      <header className="max-w-7xl mx-auto px-6 w-full h-20 flex items-center justify-between border-b border-slate-800/60">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-brand-600 flex items-center justify-center font-bold text-white shadow-glow">
            NT
          </div>
        ...
        <button className="px-4 py-2 rounded-xl text-xs font-bold text-white bg-brand-600 hover:bg-brand-500 transition shadow-glow">
          Get Started Free
        </button>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-6 py-16 text-center my-auto">
        ...
        <div className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800 max-w-xl mx-auto text-left space-y-3">
          ...
          <ul className="space-y-2 text-xs text-slate-400">
            <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" /> <em>&quot;What features does Flowdexx offer?&quot;</em></li>
