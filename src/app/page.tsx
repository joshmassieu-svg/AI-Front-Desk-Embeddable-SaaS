    ...
    <div className="min-h-screen bg-[#080c14] text-slate-100 flex flex-col justify-between relative overflow-hidden">
      ...
      <header className="border-b border-slate-800/80 bg-slate-950/60 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-18 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-brand-500 to-accent-400 flex items-center justify-center shadow-glow">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-brand-600 to-accent-500 hover:from-brand-500 hover:to-accent-400 rounded-xl shadow-glow transition flex items-center gap-2"
            >
      ...
      <main className="max-w-6xl mx-auto px-6 pt-16 pb-24 text-center z-10">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-white mb-6 leading-tight">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-brand-400 via-brand-300 to-accent-400">
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 mb-16">
          <Link
            href="/dashboard/overview"
            className="px-8 py-4 text-base font-bold text-white bg-gradient-to-r from-brand-600 to-accent-500 hover:from-brand-500 hover:to-accent-400 rounded-xl shadow-glow-lg transition flex items-center gap-3"
          >
      ...
      <footer className="border-t border-slate-800/80 py-6 text-center text-slate-500 text-xs">
        <p>© 2026 Flowdexx AI Platform SaaS Inc. Production-Ready Enterprise Architecture.</p>
      </footer>
    </div>
  );
}
